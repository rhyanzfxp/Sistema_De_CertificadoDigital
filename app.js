...
const MONGODB_URI = 'mongodb+srv://soulzuhn:VtdaZTsbpduPEqlz@cluster0.izbfhx4.mongodb.net/sistema_certificados?retryWrites=true&w=majority&appName=Cluster0';
...
 
   const envBase = (process.env.BASE_URL_EXTERNA || 'https://flamba-mose-preevidently.ngrok-free.dev').trim();
...
    const basePublic = process.env.BASE_URL_EXTERNA || 'https://flamba-mose-preevidently.ngrok-free.dev';
